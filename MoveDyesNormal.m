...
%counter. A flow rate will determine an adjustment to those numbers based
%on new nonfluorescent dyes replacing turned on dyes (doesn't affect
%diffusion dynamics at all)


function [dyeProps, LN] = MoveDyesNormal(dyePropsOld, dimA,HitRate,UncerHR,px,pxsize, StepSize, Conc, PercOn, dT, Vol, Area, flowRate)
...
persistent BulkOnDyes %this variable keeps track of the number of on dyes that are in the bulk solution 
