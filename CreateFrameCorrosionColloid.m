function [frame] = CreateFrameCorrosionColloid(fig, movie, A, startTime, timeStep, frameRate, dyeOn, plotTurnOns)
%creates a movie frame of the corrosion simulation with colloids instead of
%film, not complete as of 12/18/2020
...
set(gca,'xtick',[],'ytick',[]);
c.Ticks = [0.5,1.5 2.5];
c.TickLabels = {'Unexposed Fe', 'Fe', 'C'};
