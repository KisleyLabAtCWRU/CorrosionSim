...
dT=0.001; %Time between steps in seconds
...
Type=3; % 1 = Normal Distribution for walking distances
...
if Type == 1
    [frame]=NormalWalkers3(A,r1,HitRate,px,sigmax,nsteps,StepSize,Display);
elseif Type == 2
