function [frame,sz]=PoissonWalkers3(A,r1,HitRate,UncerHR,px,sigmax,nsteps,StepSize,Display)
...
for i = 1:nsteps
    ...
    r=size(m,2);
    mshift=poissrnd(StepSize,[1,r]); % Generates the distance to be moved
    nshift=poissrnd(StepSize,[1,r]);
